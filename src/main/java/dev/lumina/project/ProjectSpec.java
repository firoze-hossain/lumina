...
public record ProjectSpec(
        ...
        String nuxtNodeInterpreter,
        String nuxtCliPackage
) {
    public ProjectSpec(
    ...
    public ProjectSpec(
        ...
        this(generator, name, location, initGit, buildSystem, language, packaging,
                ...
                vueNodeInterpreter, vueCliPackage, vueDefaultSetup,
                viteNodeInterpreter, viteCliPackage, viteTemplate, viteTypeScript,
                symfonyProjectType, symfonyVersion,
                "", NuxtMetadata.RUNNER_NUXI_LATEST);
    }
    ...
    public static ProjectSpec forNuxt(
            String name,
            Path location,
            String nodeInterpreter,
            String cliPackage
    ...
    public String safeNuxtNodeInterpreter() {
        return nuxtNodeInterpreter != null ? nuxtNodeInterpreter.trim() : "";
    }

    public String safeNuxtCliPackage() {
        return nuxtCliPackage != null && !nuxtCliPackage.isBlank() ? nuxtCliPackage.trim() : NuxtMetadata.RUNNER_NUXI_LATEST;
    }

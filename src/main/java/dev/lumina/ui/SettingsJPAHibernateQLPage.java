// SettingsJPAHibernateQLPage.java
...
public class SettingsJPAHibernateQLPage extends VBox {
    public SettingsJPAHibernateQLPage() {
        ...
        String[] items = {"Attributes", "Bad token", "Comma", "Date and time", "Dot", "Entity", "Function",
            "Identification variable", "Keyword", "Number", "Operator sign", "Parameter", "Parenthesis", "String"};
        ...
        String[] settings = {"Bold", "Italic", "Foreground", "Background", "Error stripe mark", "Effects", "Underwaved"};
        for (String s : settings) {
            if (s.equals("Foreground") || s.equals("Background") || s.equals("Error stripe mark")) {
                HBox box = new HBox(4);
                box.setAlignment(Pos.CENTER_LEFT);
                Label color = new Label("■");
                color.setStyle("-fx-text-fill: #F5464D; -fx-font-size: 14px;");
        ...
        inheritCombo.getItems().addAll("Bad character", "Language Defaults");
        ...
        Label p1 = new Label("select object(o)");
        p1.setStyle("-fx-text-fill: #CF8E6D;");
        Label p2 = new Label("from Product o where o.id > 99999");
        p2.setStyle("-fx-text-fill: #D8DBE6;");
        Label p3 = new Label("and o.date > {d'2010-01-01'}");
        p3.setStyle("-fx-text-fill: #6AAB73;");
        Label p4 = new Label("and UPPER(o.name) like 'S%'");
        p4.setStyle("-fx-text-fill: #56A8F5;");
        Label p5 = new Label("and o.price > :minPrice");

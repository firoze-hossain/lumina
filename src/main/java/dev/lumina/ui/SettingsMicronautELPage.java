...
public class SettingsMicronautELPage extends VBox {
    public SettingsMicronautELPage() {
        ...
        String[] items = {"Background", "Bean prefix", "Braces", "Brackets", "Colon", "Comma", "Dot",
            "Operation sign", "Parentheses", "Expression bounds", "Identifier", "Keyword",
            "Method call", "Number"};
        ...
        inheritCombo.getItems().addAll("Metadata", "Language Defaults");
        ...
        Label p2 = new Label("#{6.0221415E+23D instanceof T(Double)}");
        p2.setStyle("-fx-text-fill: #56A8F5;");
        Label p3 = new Label("intArray[idx]-- le 0xFF");

...
/**
 * IntelliJ-style Editor > Copyright > Formatting > Java settings page.
 */
public class SettingsCopyrightFormattingJavaPage extends VBox {

    public SettingsCopyrightFormattingJavaPage() {
        ...
        // --- Location in File (Java Specific) ---
        VBox locationInFileContent = new VBox(6);
        locationInFileContent.setPadding(new Insets(6, 0, 0, 0));

        ToggleGroup javaLocationGroup = new ToggleGroup();

        RadioButton beforePackage = new RadioButton("Before package");
        beforePackage.setToggleGroup(javaLocationGroup);
        beforePackage.setSelected(true);
        beforePackage.getStyleClass().add("settings-radio");

        RadioButton beforeImports = new RadioButton("Before imports");
        beforeImports.setToggleGroup(javaLocationGroup);
        beforeImports.getStyleClass().add("settings-radio");

        RadioButton beforeClass = new RadioButton("Before class");
        beforeClass.setToggleGroup(javaLocationGroup);
        beforeClass.getStyleClass().add("settings-radio");

        locationInFileContent.getChildren().addAll(beforePackage, beforeImports, beforeClass);

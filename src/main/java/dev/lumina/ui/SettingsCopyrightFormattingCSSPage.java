...
/**
 * IntelliJ-style Editor > Copyright > Formatting > CSS settings page.
 * Matches the layout and styling of IntelliJ IDEA Copyright Formatting pages.
 */
public class SettingsCopyrightFormattingCSSPage extends VBox {

    public SettingsCopyrightFormattingCSSPage() {

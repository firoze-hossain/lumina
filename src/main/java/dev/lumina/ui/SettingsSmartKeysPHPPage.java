...
public class SettingsSmartKeysPHPPage extends VBox {
    ...
    private final CheckBox autoInsertSemicolonCheck = new CheckBox("Insert semicolon on Enter");
    ...
    public SettingsSmartKeysPHPPage() {
        ...
        autoInsertSemicolonCheck.setStyle("-fx-text-fill: #DFE1E5; -fx-font-size: 13px;");
        ...
        getChildren().addAll(autoInsertSemicolonCheck, smartIndentCheck);
    ...
    public boolean isModified() {
        ...
        return autoInsertSemicolonCheck.isSelected() != s.isPhpAutoInsertSemicolon()

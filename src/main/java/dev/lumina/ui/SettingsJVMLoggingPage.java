...
public class SettingsJVMLoggingPage extends VBox {

    public SettingsJVMLoggingPage() {
        ...
        classLabel.getStyleClass().add("settings-section");

        String[] items = {"Class name", "Log string", "Placeholder"};
        ...
        getChildren().addAll(schemeRow, classLabel, itemsBox);
    }
}
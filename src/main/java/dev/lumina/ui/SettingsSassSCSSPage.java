...
public class SettingsSassSCSSPage extends VBox {
    public SettingsSassSCSSPage() {
        ...
        String[] items = {"At-keyword", "Attribute name", "Bad character", "Braces", "Brackets",
            "Class name", "Colon", "Comma", "Comment", "Default", "Dot",
            "Extend", "Function", "Global", "Hex color"};
        ...
        inheritCombo.getItems().addAll("Attribute name (CSS)", "Language Defaults");
        ...
        Label p1 = new Label("/* Some loud comment here */");
        p1.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p2 = new Label("// And silent one");
        p2.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p3 = new Label("$padding: 1% !default");
        p3.setStyle("-fx-text-fill: #CF8E6D;");
        Label p4 = new Label("@import variables");
        p4.setStyle("-fx-text-fill: #56A8F5;");
        Label p5 = new Label("=Large-text");

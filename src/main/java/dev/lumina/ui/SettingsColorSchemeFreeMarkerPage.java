...
/**
 * Editor > Color Scheme > FreeMarker settings page.
 * Replicates 1:1 visual and functional parity with reference screenshot media_1790428959949.png:
 * - Scheme header row with dynamic switcher, actions menu, theme link, and help icon.
 * - Flat Category Tree view with 14 attributes:
 *   (Braces, Brackets, Comma, Comment, Directive, Dot, Escape, Keyword,
 *    Number, Operation sign, Parentheses, Reference, Semicolon, String).
 * - Default selection: "Escape" (foreground #CF8E6D, inherits String->Escape sequence->Valid from (Language Defaults)).
 ...
 * - Live Interactive FreeMarker Code Editor Preview with syntax tokens, token selection box,
 *   right margin guideline, and bidirectional click synchronization.
 */
public class SettingsColorSchemeFreeMarkerPage extends VBox {
    ...
    // State
    private String selectedKey = "Escape";
    private String currentInheritedTargetKey = "String->Escape sequence->Valid";
    ...
    public SettingsColorSchemeFreeMarkerPage() {
        ...
        inheritTargetLabel = new Label("String->Escape sequence->Valid");
        ...
        // 4. Live FreeMarker Code Preview Pane
    ...
    private void buildCategoryTree() {
        ...
        // 14 flat attributes matching media_1790428959949.png
        root.getChildren().addAll(
                new TreeItem<>("Braces"),
                new TreeItem<>("Brackets"),
                new TreeItem<>("Comma"),
                new TreeItem<>("Comment"),
                new TreeItem<>("Directive"),
                new TreeItem<>("Dot"),
                new TreeItem<>("Escape"),
    ...
    private void initListeners() {
        ...
        effectsCheck.setOnAction(e -> {
            if (effectsCheck.isSelected() && effectsHex == null) {
                effectsHex = foregroundHex != null ? foregroundHex : "#CF8E6D";
            }
            onAttributeControlChanged();
        });
    ...
    private void updatePreview() {
        ...
        // FreeMarker snippet matching media_1790428959949.png:
        // [#if group.userCount()>settings.minUserCount]
        // [/#if]
        // [#foreach v in [1, '2']]
        //   ${v}[/#foreach]
        // [#-- comment --]
        ...
        List<List<Token>> lines = List.of(
                List.of(
                        ...
                        new Token("#if", "Directive", "#E8BF6A"),
                        new Token(" ", null, "#BCBEC4"),
                        new Token("group", "Reference", "#BCBEC4"),
                        new Token(".", "Dot", "#BCBEC4"),
                        new Token("userCount", "Reference", "#BCBEC4"),
                        new Token("()", "Parentheses", "#BCBEC4"),
                        new Token(">", "Operation sign", "#BCBEC4"),
                        new Token("settings", "Reference", "#BCBEC4"),
                        new Token(".", "Dot", "#BCBEC4"),
                        new Token("minUserCount", "Reference", "#BCBEC4"),
                        new Token("]", "Brackets", "#BCBEC4")
                ),
                List.of(
                        new Token("[", "Brackets", "#BCBEC4"),
                ...
                List.of(
                        new Token("[", "Brackets", "#BCBEC4"),
                        new Token("#foreach", "Directive", "#E8BF6A"),
                        new Token(" ", null, "#BCBEC4"),
                        new Token("v", "Reference", "#BCBEC4"),
                        new Token(" in ", "Keyword", "#CF8E6D"),
                        new Token("[", "Brackets", "#BCBEC4"),
                        new Token("1", "Number", "#2AACB8"),
                        new Token(",", "Comma", "#BCBEC4"),
                        new Token(" ", null, "#BCBEC4"),
                        new Token("'2'", "String", "#6AAB73"),
                        new Token("]", "Brackets", "#BCBEC4"),
                        new Token("]", "Brackets", "#BCBEC4")
                ),
                List.of(
                ...
                List.of(new Token("[#-- comment --]", "Comment", "#7A7E85"))
        );

...
/**
 * IntelliJ-style Editor > Copyright > Formatting > HTML settings page.
 */
public class SettingsCopyrightFormattingHTMLPage extends VBox {

    public SettingsCopyrightFormattingHTMLPage() {
        getStyleClass().add("settings-page");
        setPadding(new Insets(12, 16, 16, 16));
        setSpacing(12);

        // ============================================================
        // Top Copyright Settings Radio Options
        // ============================================================
        ...
        // ============================================================
        // Left Column: Comment Type & Relative Location
        // ============================================================

        // --- Comment Type (Disabled for HTML) ---
        ...
        useLineComment.setDisable(true);
        ...
        // ============================================================
        // Layout Grid (Left & Right Columns)
        // ============================================================
        ...
        // ============================================================
        // Location in File (HTML-Specific Section)
        // ============================================================
        VBox locationInFileContent = new VBox(6);
        locationInFileContent.setPadding(new Insets(6, 0, 0, 0));

        ToggleGroup fileLocationGroup = new ToggleGroup();

        RadioButton beforeDoctype = new RadioButton("Before doctype");
        beforeDoctype.setToggleGroup(fileLocationGroup);
        beforeDoctype.setSelected(true);
        beforeDoctype.getStyleClass().add("settings-radio");

        RadioButton beforeRootTag = new RadioButton("Before root tag");
        beforeRootTag.setToggleGroup(fileLocationGroup);
        beforeRootTag.getStyleClass().add("settings-radio");

        locationInFileContent.getChildren().addAll(beforeDoctype, beforeRootTag);
        VBox locationInFilePane = createTitledSection("Location in File", locationInFileContent);

        // ============================================================
        // Preview Box (HTML Format)
        // ============================================================
        ...
        getChildren().addAll(topRadioBox, grid, locationInFilePane, previewArea);
    }

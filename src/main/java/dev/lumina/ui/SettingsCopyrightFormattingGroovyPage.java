...
/**
 * IntelliJ-style Editor > Copyright > Formatting > Groovy settings page.
 */
public class SettingsCopyrightFormattingGroovyPage extends VBox {

    public SettingsCopyrightFormattingGroovyPage() {

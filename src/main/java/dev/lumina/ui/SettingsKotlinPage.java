...
public class SettingsKotlinPage extends VBox {
    public SettingsKotlinPage() {
        ...
        String[] items = {"Annotation name", "Braces and Operators", "Classes and Interfaces", "Comments",
            "Dsl", "Style1", "Style2", "Style3", "Style4", "Functions", "Keywords", "Label",
            "Named argument", "Number"};
        ...
        for (String s : settings) {
            if (s.equals("Foreground") || s.equals("Background") || s.equals("Error stripe mark")) {
                ...
                color.setStyle("-fx-text-fill: #CF8E6D; -fx-font-size: 14px;");
        ...
        inheritCombo.getItems().addAll("Keyword1", "User-Defined File Types");
        ...
        Label p1 = new Label("/* Block comment */");
        p1.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p2 = new Label("package hello");
        p2.setStyle("-fx-text-fill: #6AAB73;");
        Label p3 = new Label("import kotlin.collections.* // line comment");
        p3.setStyle("-fx-text-fill: #6AAB73;");
        Label p4 = new Label("/**");
        p4.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p5 = new Label(" * Doc comment here for SomeClass");
        p5.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p6 = new Label(" * @see Iterator#next()");
        p6.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p7 = new Label(" */");
        p7.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");

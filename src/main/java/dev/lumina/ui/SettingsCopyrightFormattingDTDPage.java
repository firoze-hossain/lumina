...
/**
 * IntelliJ-style Editor > Copyright > Formatting > DTD settings page.
 * Matches the layout and styling of IntelliJ IDEA Copyright Formatting pages for DTD.
 */
public class SettingsCopyrightFormattingDTDPage extends VBox {

    public SettingsCopyrightFormattingDTDPage() {
        ...
        // ============================================================
        // Preview Box (DTD Specific Comment Format)
        // ============================================================
        ...
        // Dark IDE theme styling directly applied to override JavaFX light control background
    ...
    /**
     * Helper to build IntelliJ-style section titled headers with horizontal divider line.
     */

...
public class SettingsJSONPage extends VBox {
    public SettingsJSONPage() {
        ...
        String[] items = {"Bad character", "Braces", "Brackets", "Colon", "Comma", "Invalid escape sequence",

...
/**
 * IntelliJ-style Editor > Copyright > Formatting > JSPX settings page.
 */
public class SettingsCopyrightFormattingJSPXPage extends VBox {

    public SettingsCopyrightFormattingJSPXPage() {
        ...
        // --- Comment Type (Disabled for JSPX) ---

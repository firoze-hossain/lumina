...
/**
 * IntelliJ-style Editor > Copyright > Formatting > JSP settings page.
 */
public class SettingsCopyrightFormattingJSPPage extends VBox {

    public SettingsCopyrightFormattingJSPPage() {

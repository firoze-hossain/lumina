...
/**
 * IntelliJ-style Editor > Copyright > Formatting > Kotlin settings page.
 */
public class SettingsCopyrightFormattingKotlinPage extends VBox {

    public SettingsCopyrightFormattingKotlinPage() {

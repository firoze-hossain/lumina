...
/**
 * Editor > Color Scheme > Angular Template settings page.
 * Replicates 1:1 visual and functional parity with reference screenshot media_1790427845114.png:
 * - Scheme header row with dynamic switcher, actions menu, theme link, and help icon.
 * - Flat Category Tree view with 15 attributes:
 *   (Block braces, Block name, Braces in interpolation, Braces in plural expression,
 *    Comma in plural expression, Event binding '(event)', Plural expression,
 *    Property binding '[property]', Pseudo selector '::ng-deep', Semantic highlighting,
 *    Signal, Structural directive '*directive', Template expression, Template variable,
 *    Two way data binding '[(...)]').
 * - Default selection: "Block name" (foreground #CF8E6D, inherits Keyword from (Language Defaults)).
 ...
 * - Live Interactive Angular Code Editor Preview with syntax tokens, token selection box,
 *   right margin guideline, and bidirectional click synchronization.
 */
public class SettingsColorSchemeAngularTemplatePage extends VBox {
    ...
    // State
    private String selectedKey = "Block name";
    ...
    public SettingsColorSchemeAngularTemplatePage() {
        ...
        // 4. Live Angular Code Preview Pane
    ...
    private void buildCategoryTree() {
        ...
        // 15 flat attributes matching media_1790427845114.png
        root.getChildren().addAll(
                new TreeItem<>("Block braces"),
                new TreeItem<>("Block name"),
                new TreeItem<>("Braces in interpolation"),
                new TreeItem<>("Braces in plural expression"),
                new TreeItem<>("Comma in plural expression"),
                new TreeItem<>("Event binding '(event)'"),
                new TreeItem<>("Plural expression"),
                new TreeItem<>("Property binding '[property]'"),
                new TreeItem<>("Pseudo selector '::ng-deep'"),
                new TreeItem<>("Semantic highlighting"),
                new TreeItem<>("Signal"),
                new TreeItem<>("Structural directive '*directive'"),
                new TreeItem<>("Template expression"),
                new TreeItem<>("Template variable"),
                new TreeItem<>("Two way data binding '[(...)]'")
        );
    ...
    private void updatePreview() {
        ...
        // 18 preview lines matching media_1790427845114.png
        List<List<Token>> lines = List.of(
                List.of(
                        new Token("<li", null, "#CF8E6D"),
                        new Token(" attr=\"value\"", null, "#BABABA")
                ),
                List.of(
                        new Token("    ", null, "#BCBEC4"),
                        new Token("*ngFor", "Structural directive '*directive'", "#D5B778"),
                        new Token("=\"let hero of heroes as test\"", "Template expression", "#BCBEC4")
                ),
                List.of(
                        new Token("    ", null, "#BCBEC4"),
                        new Token("[class.selected]", "Property binding '[property]'", "#BCBEC4"),
                        new Token("=\"hero === selectedHero\"", "Template expression", "#BCBEC4")
                ),
                List.of(
                        new Token("    ", null, "#BCBEC4"),
                        new Token("(click)", "Event binding '(event)'", "#BCBEC4"),
                        new Token("=\"onSelect(hero)\">", "Template expression", "#BCBEC4")
                ),
                List.of(
                        new Token("  ", null, "#BCBEC4"),
                        new Token("{{", "Braces in interpolation", "#BCBEC4"),
                        new Token("hero.name", "Template expression", "#BCBEC4"),
                        new Token("}}", "Braces in interpolation", "#BCBEC4")
                ),
                List.of(
                        new Token("</li>", null, "#CF8E6D")
                ...
                List.of(
                        new Token("@for", "Block name", "#CF8E6D"),
                        new Token(" (hero of heroes; track heroes.name) ", "Template expression", "#BCBEC4"),
                        new Token("{", "Block braces", "#BCBEC4")
                ),
                List.of(
                        new Token("  ", null, "#BCBEC4"),
                        new Token("{{", "Braces in interpolation", "#BCBEC4"),
                ...
                List.of(
                        new Token("} ", "Block braces", "#BCBEC4"),
                        new Token("@empty", "Block name", "#CF8E6D"),
                        new Token(" {", "Block braces", "#BCBEC4")
                ),
                List.of(
                        new Token("  <p>No heroes!</p>", null, "#BCBEC4")
                ),
                List.of(
                        new Token("}", "Block braces", "#BCBEC4")
                ),
                ...
                List.of(
                        new Token("<div ", null, "#CF8E6D"),
                        new Token("*ngIf", "Structural directive '*directive'", "#D5B778"),
                        new Token("=\"", null, "#BCBEC4"),
                        new Token("heroSig", "Signal", "#56A8F5"),
                        new Token("() as hero\">", null, "#BCBEC4"),
                        new Token("{{", "Braces in interpolation", "#BCBEC4"),
                        new Token("hero.name", "Template expression", "#BCBEC4"),
                        new Token("}}", "Braces in interpolation", "#BCBEC4"),
                        new Token("</div>", null, "#CF8E6D")
                ...
                List.of(
                        new Token("{", "Braces in plural expression", "#BCBEC4"),
                        new Token("heroes.length", "Template expression", "#BCBEC4"),
                        new Token(",", "Comma in plural expression", "#BCBEC4"),
                        new Token(" plural", "Plural expression", "#BCBEC4"),
                        new Token(",", "Comma in plural expression", "#BCBEC4"),
                        new Token(" =0 {no heroes} =1 {one hero} other {", "Plural expression", "#BCBEC4"),
                        new Token("{{", "Braces in interpolation", "#BCBEC4"),
                        new Token("heroes.length", "Template expression", "#BCBEC4"),
                        new Token("}}", "Braces in interpolation", "#BCBEC4"),
                        new Token(" heroes}} found", "Plural expression", "#BCBEC4")
                ),
                List.of(
                        new Token("", null, "#BCBEC4")
                ),
                List.of(
                        new Token("<input ", null, "#CF8E6D"),
                        new Token("[(ngModel)]", "Two way data binding '[(...)]'", "#BCBEC4"),
                        new Token("=\"selectedHero.name\" ", "Template expression", "#BCBEC4"),
                        new Token("#model", "Template variable", "#C77DBB"),
                        new Token("=\"ngModel\"/>", null, "#BABABA")
                )
        );

...
public class SettingsYAMLPage extends VBox {
    public SettingsYAMLPage() {
        ...
        String[] items = {"Anchor/Alias", "Comment", "Double quoted string", "Key",
            "Sign: brace, comma, etc", "String", "Text"};
        ...
        inheritCombo.getItems().addAll("Text → Default text", "General");
        ...
        Label p1 = new Label("# Read about fixtures at http://ar.rubyonrails.org/classes/Fixtures.html");
        p1.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p2 = new Label("static_sidebar:");
        p2.setStyle("-fx-text-fill: #CF8E6D;");
        Label p3 = new Label("  id: \"foo\"");
        p3.setStyle("-fx-text-fill: #6AAB73;");
        Label p4 = new Label("  name: 'side_bar'");
        p4.setStyle("-fx-text-fill: #6AAB73;");
        Label p5 = new Label("  staged_position: 1");
        p5.setStyle("-fx-text-fill: #2AACB8;");
        Label p6 = new Label("  blog_id: 1");
        p6.setStyle("-fx-text-fill: #2AACB8;");
        Label p7 = new Label("  config: 1");
        p7.setStyle("-fx-text-fill: #2AACB8;");

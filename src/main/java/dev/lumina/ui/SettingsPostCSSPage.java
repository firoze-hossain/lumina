...
public class SettingsPostCSSPage extends VBox {
    public SettingsPostCSSPage() {
        ...
        String[] items = {"Ampersand", "At-keyword", "Attribute name", "Bad character", "Braces", "Brackets",
            "Class name", "Colon", "Comma", "Comment", "Dot", "Function", "Hex color",
            "Id selector", "Identifier", "Import"};
        ...
        inheritCombo.getItems().addAll("Braces (CSS)", "Language Defaults");
        ...
        Label p1 = new Label("@import \"manual.css\";");
        p1.setStyle("-fx-text-fill: #6AAB73;");
        Label p2 = new Label("@font-face {");
        p2.setStyle("-fx-text-fill: #CF8E6D;");
        Label p3 = new Label("  font-family: Droidsans;");
        p3.setStyle("-fx-text-fill: #56A8F5;");
        Label p4 = new Label("  src: url(Droidsans.ttf);");
        p4.setStyle("-fx-text-fill: #6AAB73;");
        Label p5 = new Label("  unicode-range: U+000-5FF, U+1e00-1fff, U+2000-2300;");

...
/**
 * Editor > Color Scheme > Dockerfile settings page.
 * Replicates 1:1 visual and functional parity with reference screenshot media_1790428926346.png:
 * - Scheme header row with dynamic switcher, actions menu, theme link, and help icon.
 * - Flat Category Tree view with 9 attributes:
 *   (Brackets, Comma, Comments, Dot, Keyword, Number, Parenthesis, String, Variable).
 * - Default selection: "Number" (foreground #2AACB8, inherits Number from (Language Defaults)).
 ...
 * - Live Interactive Dockerfile Code Editor Preview with syntax tokens, token selection box,
 *   right margin guideline, and bidirectional click synchronization.
 */
public class SettingsColorSchemeDockerfilePage extends VBox {
    ...
    // State
    private String selectedKey = "Number";
    private String currentInheritedTargetKey = "Number";
    private String currentInheritedScope = "(Language Defaults)";
    private String foregroundHex = "#2AACB8";
    ...
    public SettingsColorSchemeDockerfilePage() {
        ...
        inheritTargetLabel = new Label("Number");
        ...
        // 4. Live Dockerfile Code Preview Pane
    ...
    private void buildCategoryTree() {
        ...
        // 9 flat attributes matching media_1790428926346.png
        root.getChildren().addAll(
                new TreeItem<>("Brackets"),
                new TreeItem<>("Comma"),
                new TreeItem<>("Comments"),
                new TreeItem<>("Dot"),
                new TreeItem<>("Keyword"),
                new TreeItem<>("Number"),
                new TreeItem<>("Parenthesis"),
                new TreeItem<>("String"),
                new TreeItem<>("Variable")
        );
    ...
    private void initListeners() {
        ...
        effectsCheck.setOnAction(e -> {
            if (effectsCheck.isSelected() && effectsHex == null) {
                effectsHex = foregroundHex != null ? foregroundHex : "#2AACB8";
            }
            onAttributeControlChanged();
        });
    ...
    private void updatePreview() {
        ...
        // Dockerfile snippet matching media_1790428926346.png:
        // # Dockerfile example
        // FROM scratch
        ...
        List<List<Token>> lines = List.of(
                List.of(new Token("# Dockerfile example", "Comments", "#7A7E85")),
                List.of(
                        new Token("FROM", "Keyword", "#CF8E6D"),
                        new Token(" scratch", null, "#BCBEC4")
                ),
                List.of(
                        new Token("MAINTAINER", "Keyword", "#CF8E6D"),
                        new Token(" John Doe ", null, "#BCBEC4"),
                        new Token("(", "Parenthesis", "#BCBEC4"),
                        new Token("J", null, "#BCBEC4"),
                        new Token(".", "Dot", "#BCBEC4"),
                        new Token("D", null, "#BCBEC4"),
                        new Token(".", "Dot", "#BCBEC4"),
                        new Token(")", "Parenthesis", "#BCBEC4"),
                        new Token(" <jd@example", null, "#BCBEC4"),
                        new Token(".", "Dot", "#BCBEC4"),
                        new Token("com>", null, "#BCBEC4")
                ),
                List.of(
                        new Token("ENV", "Keyword", "#CF8E6D"),
                        new Token(" ", null, "#BCBEC4"),
                        new Token("PORT_TO_EXPOSE", "Variable", "#C77DBB"),
                        new Token("=", null, "#BCBEC4"),
                        new Token("4242", "Number", "#2AACB8")
                ),
                List.of(
                        new Token("RUN", "Keyword", "#CF8E6D"),
                        new Token(" /bin/bash", null, "#BCBEC4")
                ),
                List.of(
                        new Token("RUN", "Keyword", "#CF8E6D"),
                        new Token(" echo Scratch running ", null, "#BCBEC4"),
                        new Token(".", "Dot", "#BCBEC4"),
                        new Token(".", "Dot", "#BCBEC4"),
                        new Token(".", "Dot", "#BCBEC4"),
                        new Token(" > /dev/null", null, "#BCBEC4")
                ),
                List.of(
                        new Token("CMD", "Keyword", "#CF8E6D"),
                        new Token(" ", null, "#BCBEC4"),
                        new Token("[", "Brackets", "#BCBEC4"),
                        new Token("/usr/bin/zsh", null, "#BCBEC4"),
                ...
                List.of(
                        new Token("CMD", "Keyword", "#CF8E6D"),
                        new Token(" echo ", null, "#BCBEC4"),
                        new Token("\"String...\"", "String", "#6AAB73")
                ),
                List.of(
                        new Token("EXPOSE", "Keyword", "#CF8E6D"),
                        new Token(" ", null, "#BCBEC4"),
                        new Token("$PORT_TO_EXPOSE", "Variable", "#C77DBB"),
                        new Token(" ", null, "#BCBEC4"),
                        new Token("8080", "Number", "#2AACB8")
                ),
                List.of(
                        new Token("VOLUME", "Keyword", "#CF8E6D"),
                        new Token(" ", null, "#BCBEC4"),
                        new Token("[", "Brackets", "#BCBEC4"),
                        new Token("/my_files", null, "#BCBEC4"),
                        new Token("]", "Brackets", "#BCBEC4")
                )
        );

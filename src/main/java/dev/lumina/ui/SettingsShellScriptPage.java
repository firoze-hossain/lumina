...
public class SettingsShellScriptPage extends VBox {
    public SettingsShellScriptPage() {
        ...
        String[] items = {"Bad character", "Brace", "Bracket", "Comment", "Here-doc content",
            "Here-doc marker", "Keyword", "Number", "Operator sign", "Parameter",
            "Parenthesis", "String", "Variable", "Variable usage"};

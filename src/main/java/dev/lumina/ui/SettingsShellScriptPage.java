...
public class SettingsShellScriptPage extends VBox {
    public SettingsShellScriptPage() {
        ...
        String[] items = {"Backquotes", "Braces", "Commands", "Conditional operators", "Function declaration",
            "Here documents", "Here documents end", "Here documents start", "Keyword",
            "Line comment", "Number", "Raw string", "Redirection"};
        ...
        Label p1 = new Label("#! /usr/bin/env sh");
        p1.setStyle("-fx-text-fill: #6AAB73;");
        Label p2 = new Label("## Sample comment");
        p2.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p3 = new Label("let \"a=16 << 2\";");
        p3.setStyle("-fx-text-fill: #CF8E6D;");
        Label p4 = new Label("b=\"Sample text\";");
        p4.setStyle("-fx-text-fill: #6AAB73;");
        Label p5 = new Label("function foo() {");
        p5.setStyle("-fx-text-fill: #56A8F5;");
        Label p6 = new Label("    if [ $string1 == $string2 ]; then");
        p6.setStyle("-fx-text-fill: #D8DBE6;");
        Label p7 = new Label("    for i in `cat $varname` `for i` do");

// SettingsCopyrightFormattingPropertiesPage.java
...
public class SettingsCopyrightFormattingPropertiesPage extends VBox {

    public SettingsCopyrightFormattingPropertiesPage() {

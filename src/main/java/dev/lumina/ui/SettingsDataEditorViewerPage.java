// SettingsDataEditorViewerPage.java
...
public class SettingsDataEditorViewerPage extends VBox {

    public SettingsDataEditorViewerPage() {
        ...
        String[] items = {"Alternating row color", "Error data", "Image data", "Null data"};
        ...
        Label previewLine1 = new Label("null");
        previewLine1.setStyle("-fx-text-fill: #E5534B;");
        Label previewLine2 = new Label("400x300 PNG image 7.14K");
        previewLine2.setStyle("-fx-text-fill: #56A8F5;");
        Label previewLine3 = new Label("<failed to load>");
        previewLine3.setStyle("-fx-text-fill: #E5534B;");

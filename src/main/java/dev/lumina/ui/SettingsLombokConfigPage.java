...
public class SettingsLombokConfigPage extends VBox {
    public SettingsLombokConfigPage() {
        ...
        String[] items = {"Clear", "Comment", "Key", "Separator", "Value"};
        ...
        String[] settings = {"Bold", "Italic", "Foreground", "Background", "Error stripe mark", "Effects", "Border"};
        ...
        Label p1 = new Label("### Lombok Config");
        p1.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p2 = new Label("Key: Lombok.log.fieldName");
        p2.setStyle("-fx-text-fill: #56A8F5;");
        Label p3 = new Label("Type: string");
        p3.setStyle("-fx-text-fill: #6AAB73;");
        Label p4 = new Label("Use this name for the generated logger fields (default: 'log')");

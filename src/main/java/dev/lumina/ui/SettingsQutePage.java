...
public class SettingsQutePage extends VBox {
    public SettingsQutePage() {
        ...
        String[] items = {"Boolean", "Braces and Operators", "Comment", "Identifier", "Number",
            "Secondary keyword", "String", "Tag name", "Template background"};
        ...
        inheritCombo.getItems().addAll("Keyword", "Language Defaults");
        ...
        Label p1 = new Label("{! Qute Syntax Highlighting Demo !}");
        p1.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p2 = new Label("{#let answer = 42;}{/let}");
        p2.setStyle("-fx-text-fill: #CF8E6D;");
        Label p3 = new Label("{#if items.size > 1}");
        p3.setStyle("-fx-text-fill: #56A8F5;");
        Label p4 = new Label("  {items.size} items:");

...
public class SettingsXMLPage extends VBox {
    public SettingsXMLPage() {
        ...
        String[] items = {"Attribute name", "Attribute value", "CDATA", "Comment", "DTD",
            "Entity reference", "Tag", "Tag name", "Tag tree (level 1)", "Tag tree (level 2)",
            "Tag tree (level 3)", "Tag tree (level 4)", "Tag tree (level 5)", "Tag tree (level 6)"};

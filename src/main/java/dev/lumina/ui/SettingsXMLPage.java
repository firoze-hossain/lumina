...
public class SettingsXMLPage extends VBox {
    public SettingsXMLPage() {
        ...
        String[] items = {"Attribute Name", "Attribute Value", "Comment", "Custom Tag Name",
            "Entity Reference", "Injected Language Fragment", "Matched Tag",
            "Namespace Prefix", "Prologue", "Tag", "Tag Data", "Tag Name"};
        ...
        inheritCombo.getItems().addAll("Code → Matched brace", "General");
        ...
        Label p1 = new Label("<?xml version=\"1.0\" encoding=\"ISO-8859-1\" ?>");
        p1.setStyle("-fx-text-fill: #6AAB73;");
        Label p2 = new Label("<!DOCTYPE index>");
        p2.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p3 = new Label("<!ELEMENT someXMLExample EMPTY>");
        p3.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p4 = new Label("<index version=\"1.0\" xmlns:pf=\"http://test\">");
        p4.setStyle("-fx-text-fill: #CF8E6D;");
        Label p5 = new Label("    <name>Main_Index</name>");
        p5.setStyle("-fx-text-fill: #6AAB73;");
        Label p6 = new Label("    <indexitem text=\"rename\" target=\"refactoring.rename\"/>");
        p6.setStyle("-fx-text-fill: #56A8F5;");

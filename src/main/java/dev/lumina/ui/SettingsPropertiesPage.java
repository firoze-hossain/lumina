...
public class SettingsPropertiesPage extends VBox {
    public SettingsPropertiesPage() {
        ...
        String[] items = {"Comment", "Invalid unicode code points", "Key/value separator",
            "Property key", "Property value", "Valid string escape"};
        ...
        inheritCombo.getItems().addAll("Braces and Operators → Operation sign", "Language Defaults");
        ...
        Label p1 = new Label("# This comment starts with '#'");
        p1.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p2 = new Label("greetings=Hello");
        p2.setStyle("-fx-text-fill: #6AAB73;");
        Label p3 = new Label("! This comment starts with '!'");
        p3.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p4 = new Label("what\\=to\\=greet : \\'W\\o\\rld\\',\\tUniverse\\n\\uXXX");

// SettingsCopyrightFormattingPostCSSPage.java
...
public class SettingsCopyrightFormattingPostCSSPage extends VBox {

    public SettingsCopyrightFormattingPostCSSPage() {

...
public class SettingsCSSPage extends VBox {

    public SettingsCSSPage() {
        ...
        String[] items = {
            "Ampersand selector", "At-keyword", "Attribute name",
            "Bad character", "Braces", "Brackets", "Class name",
            "Colon", "Comma", "Comment", "Dot", "Function",
            "Hex color", "Id selector", "Identifier"
        };
        ...
        Label previewLine1 = new Label("h2.special-title:lang(en) {");
        previewLine1.setStyle("-fx-text-fill: #CF8E6D;");
        Label previewLine2 = new Label("    color: blue; /* comment */");
        previewLine2.setStyle("-fx-text-fill: #2AACB8;");
        Label previewLine3 = new Label("    &:hover {");
        previewLine3.setStyle("-fx-text-fill: #CF8E6D;");
        Label previewLine4 = new Label("        color: var(--primary-color, red);");
        previewLine4.setStyle("-fx-text-fill: #2AACB8;");
        ...
        inheritCombo.getItems().addAll("Identifier (CSS)", "Language Defaults");

...
public class SettingsJavaScriptPage extends VBox {

    public SettingsJavaScriptPage() {
        ...
        String[] items = {
            "Bad character", "Braces and Operators", "Classes", "Class name",
            "Exported class", "Static method", "Static property", "Comments",
            "Decorator", "Identifiers", "Injected Language Fragment",
            "JSX client component", "Keyword", "Number", "Object"
        };
        ...
        inheritCombo.getItems().addAll("Classes → Class name", "Language Defaults");
        ...
        Label previewLine1 = new Label("@defineElement(\"download-button\")");
        previewLine1.setStyle("-fx-text-fill: #B3AE60;");
        Label previewLine2 = new Label("class DownloadButton extends HTMLButtonElement {");
        previewLine2.setStyle("-fx-text-fill: #CF8E6D;");
        Label previewLine3 = new Label("    static STATIC_FIELD = `<span title=\"HTML injection\">${globalVariable}</span>`;");
        previewLine3.setStyle("-fx-text-fill: #6AAB73;");
        Label previewLine4 = new Label("    static get observedAttributes() {");
        ...
        previewLine6.setStyle("-fx-text-fill: #D8DBE6;");

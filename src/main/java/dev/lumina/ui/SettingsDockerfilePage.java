...
public class SettingsDockerfilePage extends VBox {

    public SettingsDockerfilePage() {
        ...
        String[] items = {"Brackets", "Comma", "Comments", "Dot", "Keyword", "Number", "Parenthesis", "String", "Variable"};
        ...
        Label previewLine1 = new Label("FROM scratch");
        previewLine1.setStyle("-fx-text-fill: #CF8E6D;");
        Label previewLine2 = new Label("MAINTAINER John Doe (J.D.) <jd@example.com>");
        previewLine2.setStyle("-fx-text-fill: #6AAB73;");
        Label previewLine3 = new Label("ENV PORT_TO_EXPOSE=4242");
        previewLine3.setStyle("-fx-text-fill: #56A8F5;");
        Label previewLine4 = new Label("RUN /bin/bash");
        previewLine4.setStyle("-fx-text-fill: #CF8E6D;");
        Label previewLine5 = new Label("RUN echo Scratch running ... > /dev/null");
        previewLine5.setStyle("-fx-text-fill: #6AAB73;");
        Label previewLine6 = new Label("CMD [\"/usr/bin/zsh\", \"-D\"]");
        previewLine6.setStyle("-fx-text-fill: #E8B450;");
        Label previewLine7 = new Label("CMD echo \"String...\"");
        previewLine7.setStyle("-fx-text-fill: #6AAB73;");
        Label previewLine8 = new Label("EXPOSE 4242");
        previewLine8.setStyle("-fx-text-fill: #56A8F5;");

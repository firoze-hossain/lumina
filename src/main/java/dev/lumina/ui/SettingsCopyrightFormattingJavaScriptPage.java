...
/**
 * IntelliJ-style Editor > Copyright > Formatting > JavaScript settings page.
 */
public class SettingsCopyrightFormattingJavaScriptPage extends VBox {

    public SettingsCopyrightFormattingJavaScriptPage() {

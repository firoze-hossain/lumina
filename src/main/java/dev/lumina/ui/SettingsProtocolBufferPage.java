// SettingsProtocolBufferPage.java
...
public class SettingsProtocolBufferPage extends VBox {
    public SettingsProtocolBufferPage() {
        ...
        String[] items = {"Block comment", "Braces", "Brackets", "Comma", "Dot", "Enum value",
            "Identifier", "Invalid escape sequence", "Keyword", "Line comment",
            "Number", "Operator", "Parentheses", "Semicolon", "Strina"};
        ...
        inheritCombo.getItems().addAll("Identifiers → Constant", "Language Defaults");
        ...
        Label p1 = new Label("// Example Protocol Buffer file.");
        p1.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label p2 = new Label("syntax = \"proto2\";");
        p2.setStyle("-fx-text-fill: #6AAB73;");
        Label p3 = new Label("package my.protobuf;");
        p3.setStyle("-fx-text-fill: #CF8E6D;");
        Label p4 = new Label("option java_multiple_files = true;");
        p4.setStyle("-fx-text-fill: #56A8F5;");
        Label p5 = new Label("option java_package = \"com.company.my.package\";");

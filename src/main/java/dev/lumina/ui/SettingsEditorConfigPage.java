...
public class SettingsEditorConfigPage extends VBox {

    public SettingsEditorConfigPage() {
        ...
        String[] items = {
            "Brace", "Bracket", "Comma", "Comment", "Identifier",
            "Invalid char escape", "Pattern", "Property key",
            "Property value", "Qualified key part", "Separator",
            "Special symbol", "Valid char escape"
        };
        ...
        Label previewLine1 = new Label("root = true");
        previewLine1.setStyle("-fx-text-fill: #D8DBE6;");
        Label previewLine2 = new Label("");
        Label previewLine3 = new Label("# this is a comment");
        previewLine3.setStyle("-fx-text-fill: #7A7E85; -fx-font-style: italic;");
        Label previewLine4 = new Label("unexpected_symbol");
        previewLine4.setStyle("-fx-text-fill: #E5534B;");
        Label previewLine5 = new Label("");
        Label previewLine6 = new Label("[*.java] ; this is comment, too");
        previewLine6.setStyle("-fx-text-fill: #6AAB73;");
        Label previewLine7 = new Label("key = value1, value2:value3");
        previewLine7.setStyle("-fx-text-fill: #D8DBE6;");
        ...
        inheritCombo.getItems().addAll("Braces and Operators → Comma", "Language Defaults");
